...
const gastroItems = [
  { icon: '📋', title: 'Svozové plány', desc: 'Harmonogram přizpůsobený vašemu provozu.' },
  { icon: '🗑️', title: 'Pronájem nádob', desc: 'Vhodné nádoby zdarma k zapůjčení.' },
  { icon: '📄', title: 'Legislativní dokumentace', desc: 'Kompletní doklady o likvidaci pro audit.' },
  { icon: '♻️', title: 'Ekologická likvidace', desc: 'Zpracování gastroodpadu i použitých olejů.' },
]
